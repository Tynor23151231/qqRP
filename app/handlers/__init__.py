...
from app.handlers import admin, button_flows, custom_rp, group_actions, name_badge, premium, profile, referral, settings, start, stats
...
def get_root_router() -> Router:
    ...
    root.include_router(button_flows.router)
